...
expName = 'Face Localization'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\jerry\\Documents\\PsychoPy Stuff\\Good old Ex 1_lastrun.py',
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='You will see a circular face patch appearing on the screen very briefly. Magic letter: m\n\n(Press the spacebar to proceed)\n\n',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
text_4 = visual.TextStim(win=win, name='text_4',
    text='Your task is to move your cursor to click the center of the face after it disappears. \n\nPlease try to remain fixated on the “+” while you adjust the cursor.\n\n(Press the spacebar to proceed)\n',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
text_7 = visual.TextStim(win=win, name='text_7',
    text='After clicking on the location of the face,  click on the “+” to start the next trial. \n\n(Press the spacebar to proceed)\n',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
text_5 = visual.TextStim(win=win, name='text_5',
    text='Please press the magic letter on the keyboard to continue.\nOtherwise, please reread the following instruction carefully to find the magic letter.\n \nIn this experiment, you need to fixate on the “+” at the center of your screen at ALL TIMES.\nYou will see a circular face patch appear on the screen very briefly. Magic letter: m.\nYour task is to move your cursor to indicate the center of the face after it disappears.\nAfter clicking the location of the face, click on the “+” to start the next trial.\n',
    font='Arial',
    pos=(0, 0), height=0.04, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
demo = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('CircleLoop-testtrial.xlsx'),
    seed=None, name='demo')
...
for thisDemo in demo:
    ...
    gotValidClick = False  # until a click is received
    # keep track of which components have finished
    backtocenterComponents = [image_4, mouse_4]
    ...
    while continueRoutine:
        ...
        # *image_4* updates
        if image_4.status == NOT_STARTED and frameN >= 0.0:
            # keep track of start time/frame for later
        ...
        # *mouse_4* updates
        if mouse_4.status == NOT_STARTED and frameN >= 0.0:
            # keep track of start time/frame for later
    ...
    for thisComponent in backtocenterComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    demo.addData('image_4.started', image_4.tStartRefresh)
    demo.addData('image_4.stopped', image_4.tStopRefresh)
    # store data for demo (TrialHandler)
    demo.addData('mouse_4.started', mouse_4.tStart)
    demo.addData('mouse_4.stopped', mouse_4.tStop)
...
# set up handler to look after randomisation of conditions etc
block = data.TrialHandler(nReps=5, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=[None],
